...
class CreateAProposWindow(Tkinter.Toplevel):
    def __init__(AProposWindow):
        ...
        AProposWindow.LabelVersion = Tkinter.Label(AProposWindow, text="Version: 0.1a ")
        AProposWindow.LabelDate = Tkinter.Label(AProposWindow, text="Build Date: 9th of May")
...
class simpleapp_tk(Tkinter.Tk):
    ...
    def initialize(self):
        ...
        can1.grid(column=1, row=22, rowspan = 5, padx=5, pady=15)
    ...
    def CreateSchema(self):
        ...
        CreateSchematWindow = CreateTestSchema (str(self.Entry3.get()), str(self.EntryPwdSys.get()))
