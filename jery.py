...
class simpleapp_tk(Tkinter.Tk):
    ...
    def initialize(self):
        ...
        buttonTest.grid(column=2, row=5, columnspan=2, sticky=W+E+N+S)
        ...
        self.ButtonTestSystemConn.grid(column=2, row=8, columnspan=3, sticky=W+E+N+S)
        ...
        self.ButtonCreateSchema.grid(column=2, row=9, columnspan=2, sticky=W+E+N+S)
        if ConfigSectionMap("Settings")['useedb'] == "False":
